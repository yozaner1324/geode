...
public class CreateRegionCommandIntegrationTest {
  ...
  public void validateDefaultExpirationAttributes() throws Exception {
    ...
    Assertions.assertThat(entryIdle).isNotNull();
    Assertions.assertThat(entryIdle.getTimeout()).isEqualTo(0);
    Assertions.assertThat(entryIdle.getAction()).isEqualTo(ExpirationAction.INVALIDATE);
    Assertions.assertThat(entryTTL).isNotNull();
    Assertions.assertThat(entryTTL.getTimeout()).isEqualTo(0);
    Assertions.assertThat(entryTTL.getAction()).isEqualTo(ExpirationAction.INVALIDATE);
    Assertions.assertThat(regionIdle).isNotNull();
    Assertions.assertThat(regionIdle.getTimeout()).isEqualTo(0);
    Assertions.assertThat(regionIdle.getAction()).isEqualTo(ExpirationAction.INVALIDATE);
    Assertions.assertThat(regionTTL).isNotNull();
    Assertions.assertThat(regionTTL.getTimeout()).isEqualTo(0);
    Assertions.assertThat(regionTTL.getAction()).isEqualTo(ExpirationAction.INVALIDATE);
  ...
  public void validateNonDefaultBinaryOptions() throws Exception {
    ...
    Assertions.assertThat(foo.getAttributes().getEnableAsyncConflation()).isTrue();
    Assertions.assertThat(foo.getAttributes().getCloningEnabled()).isTrue();
    Assertions.assertThat(foo.getAttributes().getConcurrencyChecksEnabled()).isFalse();
    Assertions.assertThat(foo.getAttributes().getMulticastEnabled()).isTrue();
    Assertions.assertThat(foo.getAttributes().getStatisticsEnabled()).isTrue();
    Assertions.assertThat(foo.getAttributes().getEnableSubscriptionConflation()).isTrue();
    Assertions.assertThat(foo.getAttributes().isDiskSynchronous()).isFalse();
  ...
  public void validateExpirationOptions() throws Exception {
    ...
    Assertions.assertThat(foo.getAttributes().getStatisticsEnabled()).isTrue();
    Assertions.assertThat(foo.getAttributes().getEntryIdleTimeout().getTimeout()).isEqualTo(3);
    Assertions.assertThat(foo.getAttributes().getEntryIdleTimeout().getAction())
        .isEqualTo(ExpirationAction.DESTROY);
    Assertions.assertThat(foo.getAttributes().getEntryTimeToLive().getTimeout()).isEqualTo(5);
    Assertions.assertThat(foo.getAttributes().getEntryTimeToLive().getAction())
        .isEqualTo(ExpirationAction.DESTROY);
    Assertions.assertThat(foo.getAttributes().getRegionIdleTimeout().getTimeout()).isEqualTo(7);
    Assertions.assertThat(foo.getAttributes().getRegionIdleTimeout().getAction())
        .isEqualTo(ExpirationAction.DESTROY);
    Assertions.assertThat(foo.getAttributes().getRegionTimeToLive().getTimeout()).isEqualTo(11);
    Assertions.assertThat(foo.getAttributes().getRegionTimeToLive().getAction())
        .isEqualTo(ExpirationAction.DESTROY);
  ...
  public void validatePartitionRegionOptions() throws Exception {
    ...
    Assertions.assertThat(foo.getAttributes().getPartitionAttributes().getLocalMaxMemory()).isEqualTo(1001);
    Assertions.assertThat(foo.getAttributes().getPartitionAttributes().getRecoveryDelay()).isEqualTo(7);
    Assertions.assertThat(foo.getAttributes().getPartitionAttributes().getRedundantCopies()).isEqualTo(1);
    Assertions.assertThat(foo.getAttributes().getPartitionAttributes().getStartupRecoveryDelay()).isEqualTo(5);
    Assertions.assertThat(foo.getAttributes().getPartitionAttributes().getTotalMaxMemory()).isEqualTo(2001);
    Assertions.assertThat(foo.getAttributes().getPartitionAttributes().getTotalNumBuckets()).isEqualTo(11);
  ...
  public void validateCallbackOptions() throws Exception {
    ...
    Assertions.assertThat(Arrays.stream(foo.getAttributes().getCacheListeners())
        .map(c -> c.getClass().getName()).collect(Collectors.toSet()))
            .contains(TestCacheListener.class.getName());
    Assertions.assertThat(foo.getAttributes().getCacheLoader().getClass().getName())
        .isEqualTo(TestCacheLoader.class.getName());
    Assertions.assertThat(foo.getAttributes().getCacheWriter().getClass().getName())
        .isEqualTo(TestCacheWriter.class.getName());
    Assertions.assertThat(foo.getAttributes().getCompressor().getClass().getName())
  ...
  public void validateConstraints() throws Exception {
    ...
    Assertions.assertThat(foo.getAttributes().getKeyConstraint().getName())
        .isEqualTo(TestConstraint.class.getName());
    Assertions.assertThat(foo.getAttributes().getValueConstraint().getName())
        .isEqualTo(TestConstraint.class.getName());
  ...
  public void validateEntryIdleTimeExpiration() throws Exception {
    ...
    Assertions.assertThat(template.getAttributes().getEntryIdleTimeout().getTimeout()).isEqualTo(7);
  ...
  public void validateTemplateRegionAttributesForReplicate() throws Exception {
    ...
    Assertions.assertThat(copy.getAttributes().getStatisticsEnabled()).isTrue();
    Assertions.assertThat(copy.getAttributes().getEnableAsyncConflation()).isTrue();
    Assertions.assertThat(copy.getAttributes().getCloningEnabled()).isTrue();
    Assertions.assertThat(copy.getAttributes().getConcurrencyChecksEnabled()).isFalse();
    Assertions.assertThat(copy.getAttributes().getMulticastEnabled()).isTrue();
    Assertions.assertThat(copy.getAttributes().getStatisticsEnabled()).isTrue();
    Assertions.assertThat(copy.getAttributes().getEnableSubscriptionConflation()).isTrue();
    Assertions.assertThat(copy.getAttributes().isDiskSynchronous()).isFalse();
    Assertions.assertThat(copy.getAttributes().getEntryIdleTimeout().getTimeout()).isEqualTo(3);
    Assertions.assertThat(copy.getAttributes().getEntryIdleTimeout().getAction())
        .isEqualTo(ExpirationAction.DESTROY);
    Assertions.assertThat(copy.getAttributes().getEntryTimeToLive().getTimeout()).isEqualTo(5);
    Assertions.assertThat(copy.getAttributes().getEntryTimeToLive().getAction())
        .isEqualTo(ExpirationAction.DESTROY);
    Assertions.assertThat(copy.getAttributes().getRegionIdleTimeout().getTimeout()).isEqualTo(7);
    Assertions.assertThat(copy.getAttributes().getRegionIdleTimeout().getAction())
        .isEqualTo(ExpirationAction.DESTROY);
    Assertions.assertThat(copy.getAttributes().getRegionTimeToLive().getTimeout()).isEqualTo(11);
    Assertions.assertThat(copy.getAttributes().getRegionTimeToLive().getAction())
        .isEqualTo(ExpirationAction.DESTROY);
    Assertions.assertThat(Arrays.stream(copy.getAttributes().getCacheListeners())
        .map(c -> c.getClass().getName()).collect(Collectors.toSet()))
            .contains(TestCacheListener.class.getName());
    Assertions.assertThat(copy.getAttributes().getCacheLoader().getClass().getName())
        .isEqualTo(TestCacheLoader.class.getName());
    Assertions.assertThat(copy.getAttributes().getCacheWriter().getClass().getName())
        .isEqualTo(TestCacheWriter.class.getName());
    Assertions.assertThat(copy.getAttributes().getCompressor().getClass().getName())
        .isEqualTo(TestCompressor.class.getName());
    Assertions.assertThat(copy.getAttributes().getKeyConstraint().getName())
        .isEqualTo(TestConstraint.class.getName());
    Assertions.assertThat(copy.getAttributes().getValueConstraint().getName())
        .isEqualTo(TestConstraint.class.getName());
  ...
  public void validateTemplateRegionAttributesForPartitionRedundant() throws Exception {
    ...
    Assertions.assertThat(copy.getAttributes().getValueConstraint().getName())
        .isEqualTo(TestConstraint.class.getName());
    Assertions.assertThat(copy.getAttributes().getPartitionAttributes().getLocalMaxMemory()).isEqualTo(1001);
    Assertions.assertThat(copy.getAttributes().getPartitionAttributes().getRecoveryDelay()).isEqualTo(7);
    Assertions.assertThat(copy.getAttributes().getPartitionAttributes().getRedundantCopies()).isEqualTo(1);
    Assertions.assertThat(copy.getAttributes().getPartitionAttributes().getStartupRecoveryDelay())
        .isEqualTo(5);
    Assertions.assertThat(copy.getAttributes().getPartitionAttributes().getTotalMaxMemory()).isEqualTo(2001);
    Assertions.assertThat(copy.getAttributes().getPartitionAttributes().getTotalNumBuckets()).isEqualTo(11);
    Assertions.assertThat(
  ...
  public void testEvictionAttributesForLRUHeap() throws Exception {
    ...
    Region foo = server.getCache().getRegion("/FOO");
    Assertions.assertThat(foo.getAttributes().getEvictionAttributes().getAction())
        .isEqualTo(EvictionAction.LOCAL_DESTROY);
    Assertions.assertThat(foo.getAttributes().getEvictionAttributes().getAlgorithm())
  ...
  public void testEvictionAttributesForLRUHeapWithObjectSizer() throws Exception {
    ...
    Assertions.assertThat(foo.getAttributes().getEvictionAttributes().getAlgorithm())
        .isEqualTo(EvictionAlgorithm.LRU_HEAP);
    Assertions.assertThat(foo.getAttributes().getEvictionAttributes().getObjectSizer().getClass().getName())
  ...
  public void testEvictionAttributesForLRUEntry() throws Exception {
    ...
    Assertions.assertThat(foo.getAttributes().getEvictionAttributes().getMaximum()).isEqualTo(1001);
  ...
  public void testEvictionAttributesForObjectSizer() throws Exception {
    ...
    Assertions.assertThat(attrs.getAction()).isEqualTo(EvictionAction.OVERFLOW_TO_DISK);
    Assertions.assertThat(attrs.getAlgorithm()).isEqualTo(EvictionAlgorithm.LRU_MEMORY);
    Assertions.assertThat(attrs.getMaximum()).isEqualTo(1001);
    Assertions.assertThat(attrs.getObjectSizer().getClass().getName())
        .isEqualTo(TestObjectSizer.class.getName());

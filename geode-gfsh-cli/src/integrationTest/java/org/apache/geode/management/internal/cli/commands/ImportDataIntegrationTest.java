...
public class ImportDataIntegrationTest {
  ...
  public void testExportImport() throws Exception {
    ...
    Assertions.assertThat(gfsh.getGfshOutput()).contains("Data imported from file");
  ...
  public void testMissingFileAndDirectory() throws Exception {
    ...
    Assertions.assertThat(gfsh.getGfshOutput()).contains("Must specify a location to load snapshot from");
  }
  ...
  private void validateImport(String value) {
    IntStream.range(0, DATA_POINTS).forEach(i -> Assert.assertEquals(value, region.get("key" + i)));
  }

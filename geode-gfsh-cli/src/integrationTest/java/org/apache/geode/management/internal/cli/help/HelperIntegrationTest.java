...
public class HelperIntegrationTest {
  ...
  public void testHelpWithNoInput() {
    ...
    Assertions.assertThat(helpLines).hasSize(2);
    Assertions.assertThat(helpLines[0].trim()).isEqualTo("help (Available)");
    Assertions.assertThat(helpLines[1].trim()).isEqualTo(CliStrings.HELP__HELP);
  }
  ...
  public void testHelpWithInput() {
    ...
    Assertions.assertThat(helpLines).hasSize(12);
    Assertions.assertThat(helpLines[0].trim()).isEqualTo("NAME");
    Assertions.assertThat(helpLines[1].trim()).isEqualTo("help");
  }
  ...
  public void testHelpWithInvalidInput() {
    ...
    Assertions.assertThat(testInvalidInput).isEqualTo("No help exists for this command.");
  }
  ...
  public void testHintWithNoInput() {
    ...
    Assertions.assertThat(hintLines).hasSize(21);
    Assertions.assertThat(hintLines[0].trim()).isEqualTo(HINT__MSG__TOPICS_AVAILABLE);
  }
  ...
  public void testHintWithInput() {
    ...
    Assertions.assertThat(testInput).contains(TOPIC_CLIENT__DESC);
  }
  ...
  public void testHintWithInvalidInput() {
    ...
    Assertions.assertThat(testInvalidInput)

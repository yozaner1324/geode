...
public class ChangeLogLevelFunctionIntegrationTest {
  ...
  public void setUp() {
    ...
    Assertions.assertThat(mainLogWriter.getLogWriterLevel()).isEqualTo(INFO.intLevel());

    securityLogWriter = (InternalLogWriter) cache.getSecurityLogger();
    Assertions.assertThat(securityLogWriter.getLogWriterLevel()).isEqualTo(INFO.intLevel());
    ...
    Assertions.assertThat(logConfig.getLogLevel()).isEqualTo(INFO.intLevel());
    Assertions.assertThat(logConfig.getSecurityLogLevel()).isEqualTo(INFO.intLevel());

    functionContext = Mockito.mock(FunctionContext.class);
    Mockito.when(functionContext.getCache()).thenReturn(cache);
    Mockito.when(functionContext.getArguments()).thenReturn(new Object[] {Level.WARN.name()});
    Mockito.when(functionContext.getResultSender()).thenReturn(Mockito.mock(ResultSender.class));
  ...
  public void changesMainLogWriterLevel() {
    ...
    Assertions.assertThat(mainLogWriter.getLogWriterLevel()).isEqualTo(WARNING.intLevel());
  }
  ...
  public void changesLogConfigLogLevel() {
    ...
    Assertions.assertThat(logConfig.getLogLevel()).isEqualTo(WARNING.intLevel());
  }
  ...
  public void changesGeodeLoggerLogLevel() {
    ...
    Assertions.assertThat(geodeLogger.getLevel()).isEqualTo(Level.WARN);
  }
  ...
  public void doesNotChangeApplicationLoggerLogLevel() {
    ...
    Assertions.assertThat(applicationLogger.getLevel()).isEqualTo(Level.INFO);
  }
  ...
  public void changesGemFireLogLevelSystemProperty() {
    ...
    Assertions.assertThat(System.getProperty(DistributionConfig.GEMFIRE_PREFIX + LOG_LEVEL))
  ...
  public void doesNotChangeGemFireSecurityLogLevelSystemProperty() {
    ...
    Assertions.assertThat(System.getProperty(DistributionConfig.GEMFIRE_PREFIX + SECURITY_LOG_LEVEL)).isNull();
  }
}

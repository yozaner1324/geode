...
public class TableBuilderJUnitTest {
  ...
  public void setUp() throws Exception {
    ...
    PowerMockito.spy(TableBuilderHelper.class);
    PowerMockito.when(TableBuilderHelper.class, "getScreenWidth").thenReturn(40);
    PowerMockito.when(TableBuilderHelper.class, "shouldTrimColumns").thenReturn(true);
  }
    ...
    for (String s : lines) {
      ...
      if (shouldTrim) {
        if (s.length() > screenWidth) {
          Assert.fail("Expected length > screenWidth: " + s.length() + " > " + screenWidth);
        }
      } else {
  ...
  public void testSanity() throws Exception {
    Assert.assertTrue(TableBuilderHelper.shouldTrimColumns());
    ...
    // Check the last line
    Assert.assertEquals("1     |1     |1", result.get(3));
  }
  ...
  public void testLastColumnTruncated() throws Exception {
    ...
    List<String> result = validateTable(table, true);
    // Check the last line
    Assert.assertEquals("1     |123456789-|123456789-|123456789..", result.get(3));
  }
  ...
  public void testLongestColumnFirstTruncated() throws Exception {
    ...
    List<String> result = validateTable(table, true);
    // Check the last line
    Assert.assertEquals("1234..|123456789-12345|123456789-|1", result.get(3));
  }
  ...
  public void testMultipleColumnsTruncated() throws Exception {
    ...
    List<String> result = validateTable(table, true);
    // Check the last line
    Assert.assertEquals("1     |123456789-|123456789..|1234567..", result.get(3));
  }
  ...
  public void testMultipleColumnsTruncatedLongestFirst() throws Exception {
    ...
    List<String> result = validateTable(table, true);
    // Check the last line
    Assert.assertEquals("123456789..|1234567..|1     |123456789-", result.get(3));
  }

  @Test
  public void testColumnsWithShortNames() throws Exception {
    PowerMockito.when(TableBuilderHelper.class, "getScreenWidth").thenReturn(9);
    Assert.assertTrue(TableBuilderHelper.shouldTrimColumns());
  ...
  public void testExceptionTooSmallWidth() throws Exception {
    PowerMockito.when(TableBuilderHelper.class, "getScreenWidth").thenReturn(7);
    Assert.assertTrue(TableBuilderHelper.shouldTrimColumns());
  ...
  public void testSeparatorWithMultipleChars() throws Exception {
    ...
    List<String> result = validateTable(table, true);
    // Check the last line
    Assert.assertEquals("1     <|>123456789-<|>123456789-<|>123..", result.get(3));
  }
  ...
  public void testManyColumns() throws Exception {
    ...
    List<String> result = validateTable(table, true);
    // Check the last line
    Assert.assertEquals("123456789-|123456789-|..|..|..|..|..|..", result.get(3));
  }
  ...
  public void testDisableColumnAdjustment() throws Exception {
    PowerMockito.when(TableBuilderHelper.class, "shouldTrimColumns").thenReturn(false);
    Assert.assertFalse(TableBuilderHelper.shouldTrimColumns());
    ...
    // Check the last line
    Assert.assertEquals("1     |123456789-|123456789-|123456789-123456789-12345|1", result.get(3));
  }
}

...
public class ExportDataIntegrationTest {
  ...
  public void testExport() throws Exception {
    ...
    Assertions.assertThat(gfsh.getGfshOutput()).contains("Data successfully exported ");
  }
  ...
  public void testMissingRegion() throws Exception {
    ...
    Assertions.assertThat(gfsh.getGfshOutput()).contains("You should specify option");
  }
  ...
  public void testMissingFileAndDirectory() throws Exception {
    ...
    Assertions.assertThat(gfsh.getGfshOutput()).contains("Must specify a location to save snapshot");
  }
  ...
  public void testParallelExportWithOnlyFile() throws Exception {
    ...
    Assertions.assertThat(gfsh.getGfshOutput()).contains("Must specify a directory to save snapshot files");
  }
  ...
  public void testSpecifyingDirectoryAndFileCommands() throws Exception {
    ...
    Assert.assertFalse(Files.exists(snapshotDir));
  }

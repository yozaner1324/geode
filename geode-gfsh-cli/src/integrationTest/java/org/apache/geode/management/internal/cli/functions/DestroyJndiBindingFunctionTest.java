...
public class DestroyJndiBindingFunctionTest {
  ...
  public void setup() throws Exception {
    destroyJndiBindingFunction = Mockito.spy(new DestroyJndiBindingFunction());
  ...
  public void destroyJndiBindingIsSuccessfulWhenBindingFound() throws Exception {
    Mockito.when(context.getArguments()).thenReturn(new Object[] {"jndi1", false});
    Mockito.when(context.getMemberName()).thenReturn("server-1");
  ...
  public void destroyJndiBindingIsSuccessfulWhenNoBindingFound() throws Exception {
    Mockito.when(context.getArguments()).thenReturn(new Object[] {"\"somectx/unknownjndi\"", false});
    Mockito.when(context.getResultSender()).thenReturn(resultSender);
  ...
  public void destroyDataSourceIsSuccessfulWhenBindingFound() throws Exception {
    Mockito.when(context.getArguments()).thenReturn(new Object[] {"jndi1", true});
    Mockito.when(context.getMemberName()).thenReturn("server-1");
    Mockito.when(context.getResultSender()).thenReturn(resultSender);
  ...
  public void destroyDataSourceIsSuccessfulWhenNoBindingFound() throws Exception {
    Mockito.when(context.getArguments()).thenReturn(new Object[] {"\"somectx/unknownjndi\"", true});
    Mockito.when(context.getResultSender()).thenReturn(resultSender);
  ...
  public void destroyDataSourceFailsWhenBindingHasInvalidType() throws Exception {
    ...
    Mockito.when(context.getArguments()).thenReturn(new Object[] {"jndi1", true});
    Mockito.when(context.getResultSender()).thenReturn(resultSender);
    DestroyJndiBindingFunction destroyFunctionSpy = Mockito.spy(destroyJndiBindingFunction);
    Mockito.doReturn(false).when(destroyFunctionSpy).isValidDataSource(ArgumentMatchers.any());

...
public class GfshConfigInitFileJUnitTest {
  ...
  public void setUp() throws Exception {
    ...
    Assert.assertEquals("user.dir", System.getProperty("user.dir"), userDir);
    Assert.assertEquals("user.home", System.getProperty("user.home"), userHome);
  }
  ...
  public void constructorArgumentUsed() throws Exception {
    ...
    Assert.assertEquals(argument, result);
  }
  ...
  public void historyFileLocationTest() throws Exception {
    ...
    Assert.assertEquals(".geode", (new File(gfshConfig.getHistoryFileName())).getParentFile().getName());
  }
}

...
public class ImportClusterConfigurationCommandDUnitTest {
  ...
  public void noServerToBeginWith() throws IOException {
    ...
    server1.invoke(() -> {
      ...
      Assertions.assertThat(region.getAttributes().getDataPolicy()).isEqualTo(DataPolicy.REPLICATE);
    });
    ...
    server2.invoke(() -> {
      ...
      Assertions.assertThat(region1).isNotNull();
    ...
    server1.invoke(() -> {
      ...
      Region region2 = ClusterStartupRule.getCache().getRegion("regionForGroupA");
      Assertions.assertThat(region1).isNotNull();
      Assertions.assertThat(region2).isNull();
    });
  }

...
public class DiskStoreCommandsDUnitTest implements Serializable {
  ...
  public void testMissingDiskStore() throws Exception {
    ...
    Assertions.assertThat(diskstoreIDs.size()).isEqualTo(1);
    ...
    server1.invoke(() -> {
      ...
      Assertions.assertThat(cache).isNotNull();
      Region<String, String> r = cache.getRegion(REGION_1);
      Assertions.assertThat(r.get("A")).isEqualTo("B");
    });
  }
  ...
  public void testCannotDestroyDiskStoreInUse() throws Exception {
    ...
    Assertions.assertThat(diskStoreExistsInClusterConfig(locator)).isTrue();
  }
  ...
  public void testDestroyUpdatesSharedConfig() throws Exception {
    ...
    gfsh.executeAndAssertThat(
        ...
        .statusIsSuccess();
    Assertions.assertThat(diskStoreExistsInClusterConfig(locator)).isFalse();
  }
  ...
  public void destroyDiskStoreIsIdempotent() throws Exception {
    ...
    locator.invoke(() -> {
      ...
      Assertions.assertThat(internalLocator).isNotNull();
      ...
      Assertions.assertThat(config.getDiskStores().size()).isEqualTo(0);
    });
  ...
  public void offlineDiskStoreCommandShouldNotCreateFolderIfDiskStoreDoesNotExist(
    ...
    Assertions.assertThat(Files.exists(nonExistingDiskStorePath)).isFalse();
  ...
  private void verifyDiskStoreInServer(String diskStoreName, String diskDirectoryName) {
    ...
    Assertions.assertThat(diskStore).isNotNull();
    File[] diskDirs = diskStore.getDiskDirs();
    Assertions.assertThat(diskDirs.length).isEqualTo(1);
    ...
    Assertions.assertThat(diskDir.getAbsolutePath()).isEqualTo(absoluteDiskDirectoryName);
  }
  ...
  private void verifyDiskStoreInClusterConfiguration(String absoluteDirectoryName) {
    ...
    Assertions.assertThat(diskStores.size()).isEqualTo(1);
    DiskStoreType diskStore = diskStores.get(0);
    List<DiskDirType> diskDirs = diskStore.getDiskDirs();
    Assertions.assertThat(diskDirs.size()).isEqualTo(1);
    DiskDirType diskDir = diskDirs.get(0);
    Assertions.assertThat(diskDir.getContent()).isEqualTo(absoluteDirectoryName);
  }
}

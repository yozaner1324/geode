...
public class CreateRegionCommandPersistsConfigurationDUnitTest {
  ...
  public void createRegionPersistsDefaultConfig() {
    ...
    locator.invoke(() -> {
      ...
      Assertions.assertThat(regionConfig).isNotNull();
      Assertions.assertThat(regionConfig.getName()).isEqualTo(regionName);
      Assertions.assertThat(regionConfig.getIndexes()).isEmpty();
      Assertions.assertThat(regionConfig.getRegions()).isEmpty();
      Assertions.assertThat(regionConfig.getEntries()).isEmpty();
      Assertions.assertThat(regionConfig.getCustomRegionElements()).isEmpty();
    });
  }
  ...
  public void createRegionPersistsConfigParams() {
    ...
    locator.invoke(() -> {
      ...
      Assertions.assertThat(regionConfig).isNotNull();
      Assertions.assertThat(regionConfig.getName()).isEqualTo(regionName);
      Assertions.assertThat(regionConfig.getRegionAttributes()).isNotNull();

      RegionAttributesType attr = regionConfig.getRegionAttributes();
      Assertions.assertThat(attr.isStatisticsEnabled()).isTrue();
      Assertions.assertThat(attr.isEnableAsyncConflation()).isTrue();

      RegionAttributesType.ExpirationAttributesType entryIdleTimeExp = attr.getEntryIdleTime();
      Assertions.assertThat(entryIdleTimeExp.getTimeout()).isEqualTo("100");
    });

    server1.invoke(() -> {
      Region<?, ?> region = ClusterStartupRule.getCache().getRegion(regionName);
      Assertions.assertThat(region.getAttributes().getStatisticsEnabled())
          .describedAs("Expecting statistics to be enabled")
          .isTrue();
      Assertions.assertThat(region.getAttributes().getEnableAsyncConflation())
          .describedAs("Expecting async conflation to be enabled")
          .isTrue();
      Assertions.assertThat(region.getAttributes().getEntryIdleTimeout().getTimeout())
  ...
  public void createRegionDoesNotPersistEmptyOrDefaultEvictionAttributes() {
    ...
    locator.invoke(() -> {
      ...
      regionNames.forEach(name -> {
        ...
        RegionAttributesType attr = regionConfig.getRegionAttributes();
        Assertions.assertThat(attr.getEvictionAttributes())
  ...
  public void createRegionPersistsAEQConfig() {
    ...
    locator.invoke(() -> {
      ...
      Assertions.assertThat(regionConfig.getRegionAttributes().getAsyncEventQueueIds())
          .contains(queueId);
    });
  }
  ...
  public void createRegionWithColocation() {
    ...
    locator.invoke(() -> {
      ...
      List<RegionConfig> regions = config.getRegions();
      Assertions.assertThat(regions).isNotEmpty();
      Assertions.assertThat(regions).hasSize(3);
  ...
  public void createRegionPersistsDiskstores() throws Exception {
    ...
    locator.invoke(() -> {
      ...
      regionNames.forEach(name -> {
        ...
        Assertions.assertThat(regionAttributes.getDiskStoreName())
            .isEqualTo(store);
        Assertions.assertThat(regionAttributes.isDiskSynchronous())
            .isTrue();
      });
    });
  }
  ...
  public void createRegionPersistsPartitionAttributes() {
    ...
    locator.invoke(() -> {
      ...
      regionNames.forEach(name -> {
        ...
        Assertions.assertThat(partitionAttributes.getRecoveryDelay())
            .describedAs("Recovery delay should be 1 for region " + name)
            .isEqualTo("1");
        Assertions.assertThat(partitionAttributes.getLocalMaxMemory())
            .describedAs("Local max memory should be 1000 for region " + name)
            .isEqualTo("1000");
        Assertions.assertThat(partitionAttributes.getRedundantCopies())
            .describedAs("Redundant copies should be 1 for region " + name)
            .isEqualTo("1");
        Assertions.assertThat(partitionAttributes.getStartupRecoveryDelay())
            .describedAs("Startup recovery delay should be 1 for region " + name)
            .isEqualTo("1");
        Assertions.assertThat(partitionAttributes.getTotalMaxMemory())
            .describedAs("Total max memory should be 100 for region " + name)
            .isEqualTo("100");
        Assertions.assertThat(partitionAttributes.getTotalNumBuckets())
  ...
  public void createRegionPersistsPartitionResolver() {
    ...
    locator.invoke(() -> {
      ...
      Assertions.assertThat(partitionAttributes.getPartitionResolver().getClassName())
  ...
  public void createRegionDoesNotPersistEmptyOrDefaultPartitionAttributes() {
    ...
    locator.invoke(() -> {
      ...
      Assertions.assertThat(regionConfig).isNotNull();
      Assertions.assertThat(regionConfig.getName()).isEqualTo(regionFromTemplateName);
      Assertions.assertThat(regionConfig.getRegionAttributes()).isNotNull();

      RegionAttributesType attr = regionConfig.getRegionAttributes();
      Assertions.assertThat(attr.getPartitionAttributes())
  ...
  public void createRegionDoestNotPersistEmptyOrDefaultExpirationAttributes() {
    ...
    locator.invoke(() -> {
      ...
      RegionAttributesType attr = regionConfig.getRegionAttributes();
      Assertions.assertThat(attr.getRegionTimeToLive())
          .describedAs("Expiration attributes should be null for " + regionName)
          .isNull();
      Assertions.assertThat(attr.getRegionIdleTime())
          .describedAs("Expiration attributes should be null for " + regionName)
          .isNull();
      Assertions.assertThat(attr.getEntryIdleTime())
          .describedAs("Expiration attributes should be null for " + regionName)
          .isNull();
      Assertions.assertThat(attr.getEntryTimeToLive())
          .describedAs("Expiration attributes should be null for " + regionName)
          .isNull();
    });
  }
  ...
  public void createRegionPersistsDisableCloningSetting() {
    ...
    locator.invoke(() -> {
      ...
      regionNames.forEach(name -> {
        ...
        RegionAttributesType attr = regionConfig.getRegionAttributes();
        Assertions.assertThat(attr.isCloningEnabled())
  ...
  public void createRegionPersistsCustomExpiryClass() {
    ...
    locator.invoke(() -> {
      ...
      Assertions.assertThat(regionConfig.getRegionAttributes()).isNotNull();
      RegionAttributesType attr = regionConfig.getRegionAttributes();
      Assertions.assertThat(attr.getEntryIdleTime().getCustomExpiry().toString())
  ...
  public void createRegionPersistsDataPolicy() {
    ...
    locator.invoke(() -> {
      ...
      RegionAttributesType attr = regionConfig.getRegionAttributes();
      Assertions.assertThat(attr.getDataPolicy())
  ...
  public void createRegionPersistsScope() {
    ...
    locator.invoke(() -> {
      ...
      Assertions.assertThat(regionConfig1).isNotNull();
      Assertions.assertThat(regionConfig1.getName()).isEqualTo(regionName);
      Assertions.assertThat(regionConfig1.getRegionAttributes()).isNotNull();

      RegionAttributesType attr1 = regionConfig1.getRegionAttributes();
      Assertions.assertThat(attr1.getScope())
          .describedAs("Scope for partitioned region should be null")
          .isNull();

      RegionConfig regionConfig2 = find(config.getRegions(), regionName2);
      Assertions.assertThat(regionConfig2).isNotNull();
      Assertions.assertThat(regionConfig2.getName()).isEqualTo(regionName2);
      Assertions.assertThat(regionConfig2.getRegionAttributes()).isNotNull();

      RegionAttributesType attr2 = regionConfig2.getRegionAttributes();
      Assertions.assertThat(attr2.getScope())
          .describedAs(

...
public class DescribeMembersCommandDUnitTest {
  ...
  public void describeLocator() throws Exception {
    ...
    Assertions.assertThat(memberInfo.get("Name")).isEqualTo("locator-0");
    Assertions.assertThat(memberInfo.get("Id")).contains("locator-0");
    Assertions.assertThat(memberInfo.get("Host")).as("Host").isNotBlank();
    Assertions.assertThat(memberInfo.get("PID")).as("PID").isNotBlank();
    Assertions.assertThat(memberInfo.get("Used Heap")).as("Used Heap").isNotBlank();
    Assertions.assertThat(memberInfo.get("Max Heap")).as("Max Heap").isNotBlank();
    Assertions.assertThat(memberInfo.get("Working Dir")).as("Working Dir").isNotBlank();
    Assertions.assertThat(memberInfo.get("Log file")).as("Log File").isNotBlank();
    Assertions.assertThat(memberInfo.get("Locators")).as("Locators").isNotBlank();
  }

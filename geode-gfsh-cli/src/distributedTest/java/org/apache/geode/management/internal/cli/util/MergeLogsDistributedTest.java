...
public class MergeLogsDistributedTest {
  ...
  public void testExportInProcess() throws Exception {
    ...
    Assertions.assertThat(actualFiles).hasSize(4);
  ...
  private void assertOnLogContents(File mergedLogFile) throws IOException {
    ...
    Assertions.assertThat(mergedLines).contains(MESSAGE_1);
    Assertions.assertThat(mergedLines).contains(MESSAGE_2);
    Assertions.assertThat(mergedLines).contains(MESSAGE_3);
    Assertions.assertThat(mergedLines).contains(MESSAGE_4);
    Assertions.assertThat(mergedLines).contains(MESSAGE_5);
    Assertions.assertThat(mergedLines).contains(MESSAGE_6);

    // Make sure that our merged log file contains the proper ordering
    Assertions.assertThat(mergedLines.indexOf(MESSAGE_1)).isLessThan(mergedLines.indexOf(MESSAGE_2));
    Assertions.assertThat(mergedLines.indexOf(MESSAGE_2)).isLessThan(mergedLines.indexOf(MESSAGE_3));
    Assertions.assertThat(mergedLines.indexOf(MESSAGE_3)).isLessThan(mergedLines.indexOf(MESSAGE_4));
    Assertions.assertThat(mergedLines.indexOf(MESSAGE_4)).isLessThan(mergedLines.indexOf(MESSAGE_5));
    Assertions.assertThat(mergedLines.indexOf(MESSAGE_5)).isLessThan(mergedLines.indexOf(MESSAGE_6));
  }
}

...
public class CreateDefinedIndexesCommandDUnitTest {
  ...
  public void nonexistentRegion() {
    ...
    VMProvider.invokeInEveryMember(() -> {
      ...
      Assertions.assertThat(cache.getRegion(regionName)).isNull();
    ...
    VMProvider.invokeInEveryMember(() -> {
      ...
      Assertions.assertThat(currentIndexes).doesNotContain(indexName);
    }, server1, server2, server3);
  }
  ...
  public void multipleIndexesOnMultipleRegionsClusterWide() {
    ...
    VMProvider.invokeInEveryMember(() -> {
      Cache cache = ClusterStartupRule.getCache();
      Assertions.assertThat(cache.getRegion(region1Name)).isNotNull();
      Assertions.assertThat(cache.getRegion(region2Name)).isNotNull();
    }, server1, server2, server3);
    ...
    gfsh.executeAndAssertThat("create defined indexes")
        ...
        .hasTableSection(CreateDefinedIndexesCommand.CREATE_DEFINED_INDEXES_SECTION)
        .hasRowSize(6);
    Assertions.assertThat(gfsh.getGfshOutput())
    ...
    VMProvider.invokeInEveryMember(() -> {
      ...
      Assertions.assertThat(queryService.getIndexes(region1).size()).isEqualTo(1);
      Assertions.assertThat(queryService.getIndexes(region2).size()).isEqualTo(1);
      Assertions.assertThat(queryService.getIndex(region1, index1Name)).isNotNull();
      Assertions.assertThat(queryService.getIndex(region2, index2Name)).isNotNull();
    }, server1, server2, server3);
    ...
    locator.invoke(() -> {
      ...
      Assertions.assertThat(region1Config.getIndexes().stream().map(RegionConfig.Index::getName)
      ...
      Assertions.assertThat(region2Config.getIndexes().stream().map(RegionConfig.Index::getName)
  ...
  public void multipleIndexesOnMultipleRegionsInMemberGroup() {
    ...
    VMProvider.invokeInEveryMember(() -> {
      Cache cache = ClusterStartupRule.getCache();
      Assertions.assertThat(cache.getRegion(region1Name)).isNull();
      Assertions.assertThat(cache.getRegion(region2Name)).isNull();
    }, server3);
    ...
    locator.invoke(() -> {
      ...
      InternalConfigurationPersistenceService sharedConfig =
          ((InternalLocator) Locator.getLocator()).getConfigurationPersistenceService();
      Assertions.assertThat(sharedConfig.getConfiguration("group1").getCacheXmlContent()).contains(index2Name,
          index1Name);
    });
  }
  ...
  public void disjointRegionsAndGroupsFailsToDefineIndexes() {
    ...
    VMProvider.invokeInEveryMember(() -> {
      ...
      Assertions.assertThat(queryService.getIndexes(region1)).isNotNull();
      Assertions.assertThat(queryService.getIndexes(region1).isEmpty()).isTrue();
    }, server1, server2);
    ...
    VMProvider.invokeInEveryMember(() -> {
      ...
      Assertions.assertThat(queryService.getIndexes(region2)).isNotNull();
      Assertions.assertThat(queryService.getIndexes(region2).isEmpty()).isTrue();
    }, server3);
    ...
    locator.invoke(() -> {
      ...
      InternalConfigurationPersistenceService sharedConfig =
          ((InternalLocator) Locator.getLocator()).getConfigurationPersistenceService();
      Assertions.assertThat(sharedConfig.getConfiguration("group1").getCacheXmlContent())
          .doesNotContain(index1Name);
      Assertions.assertThat(sharedConfig.getConfiguration("group2").getCacheXmlContent())

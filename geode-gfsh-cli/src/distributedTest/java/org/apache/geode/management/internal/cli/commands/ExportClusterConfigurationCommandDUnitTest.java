...
public class ExportClusterConfigurationCommandDUnitTest {
  ...
  public void getClusterConfigWithFile() throws IOException {
    ...
    Assertions.assertThat(content).startsWith("<?xml version=\"1.0\" encoding=\"UTF-8\" standalone=\"no\"?>")
  ...
  public void testExportClusterConfig(String zipFilePath) throws Exception {
    ...
    Assertions.assertThat(exportedZip).exists();
    ...
    Assertions.assertThat(actualZipEnries).isEqualTo(expectedZipEntries);
  }

...
public class AlterAsyncEventQueueCommandDUnitTest {
  ...
  public void testAlterAsyncEventQueue() throws Exception {
    ...
    server1.invoke(() -> {
      ...
      Assertions.assertThat(queue.getBatchSize()).isEqualTo(GatewaySender.DEFAULT_BATCH_SIZE);
      Assertions.assertThat(queue.getBatchTimeInterval()).isEqualTo(DEFAULT_BATCH_TIME_INTERVAL);
      Assertions.assertThat(queue.getMaximumQueueMemory())
    ...
    server1.invoke(() -> {
      ...
      Assertions.assertThat(queue.getMaximumQueueMemory())
          .isEqualTo(GatewaySender.DEFAULT_MAXIMUM_QUEUE_MEMORY);
      Assertions.assertThat(cache.getAsyncEventQueue("queue2")).isNull();
    });
    ...
    server1.invoke(() -> {
      InternalCache cache = ClusterStartupRule.getCache();
      AsyncEventQueue queue = cache.getAsyncEventQueue("queue1");
      Assertions.assertThat(queue.getBatchSize()).isEqualTo(ALTERED_BATCH_SIZE);
      Assertions.assertThat(queue.getBatchTimeInterval()).isEqualTo(ALTERED_BATCH_TIME_INTERVAL);
      Assertions.assertThat(queue.getMaximumQueueMemory()).isEqualTo(ALTERED_MAXIMUM_QUEUE_MEMORY);
      Assertions.assertThat(cache.getAsyncEventQueue("queue2")).isNull();
    });
  }
  ...
  public void whenAlterCommandUsedToChangeFromPauseToResumeThenAEQBehaviorMustChange()
    ...
    server1.invoke(() -> {
      ...
      Assertions.assertThat(queue.getBatchSize()).isEqualTo(GatewaySender.DEFAULT_BATCH_SIZE);
      Assertions.assertThat(queue.getBatchTimeInterval()).isEqualTo(DEFAULT_BATCH_TIME_INTERVAL);
      Assertions.assertThat(queue.isDispatchingPaused()).isTrue();
      Assertions.assertThat(queue.getMaximumQueueMemory())
          .isEqualTo(GatewaySender.DEFAULT_MAXIMUM_QUEUE_MEMORY);
    });
    ...
    server1.invoke(() -> {
      ...
      Assertions.assertThat(queue.getBatchTimeInterval()).isEqualTo(ALTERED_BATCH_TIME_INTERVAL);
      Assertions.assertThat(queue.getMaximumQueueMemory()).isEqualTo(ALTERED_MAXIMUM_QUEUE_MEMORY);
      Assertions.assertThat(queue.isDispatchingPaused()).isFalse();
      Assertions.assertThat(cache.getAsyncEventQueue("queue2")).isNull();
    });
  }

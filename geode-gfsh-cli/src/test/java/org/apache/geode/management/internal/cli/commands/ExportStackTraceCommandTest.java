...
public class ExportStackTraceCommandTest {
  ...
  @Before
  public void before() {
    command = Mockito.spy(ExportStackTraceCommand.class);
  }
  ...
  public void getHeaderMessageWithTimestamp() throws IOException {
    ...
    Assertions.assertThat(headerMessage).isEqualTo("server at " + formatter.format(time));
  }
  ...
  public void getHeaderMessageWithoutTimestamp() throws IOException {
    ...
    Assertions.assertThat(headerMessage).isEqualTo("server");
  }
}

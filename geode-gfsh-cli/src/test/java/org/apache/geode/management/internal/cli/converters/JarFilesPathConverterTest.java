...
public class JarFilesPathConverterTest {
  ...
  public void itFindsJarDirs() throws Exception {
    ...
    Assertions.assertThat(completions.size()).isEqualTo(1);
    Assertions.assertThat(completions.get(0).getValue()).endsWith("lib");
  }
  ...
  public void itFindsJarFiles() throws Exception {
    ...
    Assertions.assertThat(completions.size()).isEqualTo(2);
    Assertions.assertThat(completions.get(0).getValue()).endsWith(".jar");
  }
  ...
  public void itFindsDirsWithSubdirs() throws Exception {
    ...
    Assertions.assertThat(completions.size()).isEqualTo(1);
    Assertions.assertThat(completions.get(0).getValue()).endsWith("nonEmpty");
    Assertions.assertThat(completions.get(0).getValue()).startsWith("garbage,");
  }
  ...
  public void itFindsDirsWithSubdirsAndJars() throws Exception {
    ...
    Assertions.assertThat(completions).hasSize(2);
    Assertions.assertThat(completions).containsExactlyInAnyOrder(new Completion(nonEmptyDir.getPath()),
  ...
  public void itFindsNothingWithBadSearch() throws Exception {
    ...
    Assertions.assertThat(completions).isEmpty();
  }
  ...
  public void itFindsNothing() throws Exception {
    ...
    Assertions.assertThat(completions.size()).isEqualTo(0);
  }

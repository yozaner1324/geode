...
public class OnlineCommandProcessorTest {
  ...
  public void before() {
    ...
    result = Mockito.mock(ResultModel.class);
    Mockito.when(executor.execute(ArgumentMatchers.any())).thenReturn(result);
  ...
  public void executeWithNullThrowsNPE() throws Exception {
    Java6Assertions.assertThatThrownBy(() -> onlineCommandProcessor.executeCommand(null))
  ...
  public void executeStripsComments() throws Exception {
    ...
    Java6Assertions.assertThat(commandResult).isNull();
  }
  ...
  public void handlesNotAuthorizedException() throws Exception {
    ...
    Java6Assertions.assertThatThrownBy(() -> onlineCommandProcessor.executeCommand("start locator"))

...
public class GfshParserJUnitTest {
  ...
  public void testSplitUserInputDoubleQuotes() {
    ...
    Assertions.assertThat(tokens.get(0)).isEqualTo("query");
    Assertions.assertThat(tokens.get(1)).isEqualTo("--query");
    Assertions.assertThat(tokens.get(2)).isEqualTo("\"select * from /region\"");
  }
  ...
  public void testSplitUserInputWithMixedQuotes() {
    ...
    tokens = GfshParser.splitUserInput(input);
    Assertions.assertThat(tokens.size()).isEqualTo(3);
    Assertions.assertThat(tokens.get(0)).isEqualTo("command");
    Assertions.assertThat(tokens.get(1)).isEqualTo("option");
    Assertions.assertThat(tokens.get(2)).isEqualTo("'test1 \"test \" test1'");
  }
  ...
  public void testSplitUserInputWithJ() {
    ...
    tokens = GfshParser.splitUserInput(input);
    Assertions.assertThat(tokens.size()).isEqualTo(10);
    Assertions.assertThat(tokens.get(5)).isEqualTo("\"-Dgemfire.start-dev-rest-api=true\"");
    Assertions.assertThat(tokens.get(7)).isEqualTo("'-Dgemfire.http-service-port=8080'");
    Assertions.assertThat(tokens.get(9))
  ...
  public void splitWithWhiteSpacesExceptQuoted() {
    ...
    tokens = GfshParser.splitUserInput(input);
    Assertions.assertThat(tokens.size()).isEqualTo(4);
    Assertions.assertThat(tokens.get(3)).isEqualTo("\"my.abc{'k1' : 'v   1', 'k2' : 'v2'}\"");
  }
  ...
  public void testSplitUserInputWithJNoQuotes() {
    ...
    tokens = GfshParser.splitUserInput(input);
    Assertions.assertThat(tokens.size()).isEqualTo(8);
    Assertions.assertThat(tokens.get(5)).isEqualTo("-Dgemfire.start-dev-rest-api=true");
    Assertions.assertThat(tokens.get(7)).isEqualTo("-Dgemfire.http-service-port=8080");
  }
  ...
  public void testSplitJsonValue() throws Exception {
    ...
    tokens = GfshParser.splitUserInput(input);
    Assertions.assertThat(tokens.size()).isEqualTo(5);
    Assertions.assertThat(tokens.get(2)).isEqualTo("('id':'testKey0')");
  }
  ...
  public void spaceOrEmptyStringIsParsedCorrectly() {
    ...
    tokens = GfshParser.splitUserInput(input);
    Assertions.assertThat(tokens.size()).isEqualTo(8);
    Assertions.assertThat(tokens.get(7)).isEqualTo("' '");
    Assertions.assertThat(tokens.get(5)).isEqualTo("''");
  }
}

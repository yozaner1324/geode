...
public class ShutdownCommandInterceptorTest {
  ...
  public void before() throws Exception {
    interceptor = Mockito.spy(ShutdownCommand.ShutdownCommandInterceptor.class);
  }

  @Test
  public void whenRespondNo() {
    doReturn(AbstractCliAroundInterceptor.Response.NO).when(interceptor).readYesNo(ArgumentMatchers.any(), ArgumentMatchers.any());

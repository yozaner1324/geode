...
public class JdkToolTest {
  ...
  public void testGetJdkToolPathnameWithNullPathnames() {
    try {
      ...
      Assert.assertEquals("The JDK tool executable pathnames cannot be null!", expected.getMessage());
      throw expected;
    }
  }
  ...
  public void testGetJdkToolPathnameWithNullGemFireException() {
    try {
      ...
      Assert.assertEquals("The GemFireException cannot be null!", expected.getMessage());
      throw expected;
    }
  }

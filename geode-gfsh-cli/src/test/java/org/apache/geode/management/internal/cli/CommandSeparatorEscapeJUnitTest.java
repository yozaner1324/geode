...
public class CommandSeparatorEscapeJUnitTest {
  ...
  public void testSingleCommand() {
    ...
    Assert.assertEquals("stop server", split.get(0));
  }
  ...
  public void testMultiCommand() {
    ...
    Assert.assertEquals("stop server1 --option1=value1", split.get(0));
    Assert.assertEquals(" stop server2", split.get(1));
    Assert.assertEquals("stop server3 ", split.get(2));
  }
  ...
  public void testMultiCommandWithCmdSep() {
    ...
    Assert.assertEquals("put --region=/region1 --key='key1;part' --value='value1;part2'", split.get(0));
    Assert.assertEquals("put --region=/region1 --key='key2;part' --value='value2;part2'", split.get(1));
  }
  ...
  public void testSingleCommandWithComma() {
     ...
     */
    Assert.assertEquals(1, split.size());
    Assert.assertEquals("put --region=/region1 --key='key;part' --value='value;part2'", split.get(0));
  }
  ...
  public void testMultiCmdCommaValueFirst() {
    ...
    Assert.assertEquals(2, split.size());
    Assert.assertEquals("put --region=/region1 --key='key;part' --value='value;part2'", split.get(0));
    Assert.assertEquals("stop server", split.get(1));
  }
  ...
  public void testMultiCmdCommaValueLast() {
    ...
    Assert.assertEquals(2, split.size());
    Assert.assertEquals("stop server", split.get(0));
    Assert.assertEquals("put --region=/region1 --key='key;part' --value='value;part2'", split.get(1));
  }
  ...
  public void testMultiCmdCommaValueMiddle() {
    ...
    Assert.assertEquals("stop server1", split.get(0));
    Assert.assertEquals("put --region=/region1 --key='key;part' --value='value;part2'", split.get(1));
    Assert.assertEquals("stop server2", split.get(2));
    Assert.assertEquals("stop server3", split.get(3));
  }

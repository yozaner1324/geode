...
public class ExportLogsFunctionTest {
  ...
  public void defaultExportLogLevelShouldBeAll() {
    Assert.assertTrue(ExportLogsCommand.DEFAULT_EXPORT_LOG_LEVEL.equals("ALL"));
    Assert.assertEquals(LogLevel.getLevel(ExportLogsCommand.DEFAULT_EXPORT_LOG_LEVEL), Level.ALL);
  }

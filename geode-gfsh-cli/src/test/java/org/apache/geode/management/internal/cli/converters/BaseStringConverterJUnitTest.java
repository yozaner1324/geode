...
public class BaseStringConverterJUnitTest {
  ...
  public void before() {
    ...
    Mockito.when(converter.getCompletionValues())
  ...
  public void complete() throws Exception {
    ...
    Assertions.assertThat(candidate.size()).isEqualTo(allMemberNames.length);
    Assertions.assertThat(candidate.getFirstCandidate()).isEqualTo(gfshCommand + allMemberNames[0]);
  }
}

...
public class CreateJndiBindingCommandTest {
  ...
  public void setUp() throws Exception {
    ...
    command = Mockito.spy(CreateJndiBindingCommand.class);
  ...
  public void configPropertyIsProperlyParsed() {
    ...
    Assertions.assertThat(configProperties).hasSize(2);
    Assertions.assertThat(configProperties[0].getValue()).isEqualTo("value1");
    Assertions.assertThat(configProperties[1].getValue()).isEqualTo("value2");
  }
  ...
  public void whenMembersFoundAndNoClusterConfigRunningThenOnlyInvokeFunction() {
    ...
    Assertions.assertThat(creatingDataSource).isFalse();
    Assertions.assertThat(jndiConfig.getJndiName()).isEqualTo("name");
    Assertions.assertThat(jndiConfig.getConfigProperties().get(0).getName()).isEqualTo("name1");

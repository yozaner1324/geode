...
public class DiskStoreCommandsUtilsTest {
  ...
  public void diskStoreBeanAndMemberBeanDiskStoreExists() throws Exception {
    ...
    Mockito.doReturn(memberDiskStore).when(distributedSystemMXBean).listMemberDiskstore();
    Mockito.doReturn(objectName).when(distributedSystemMXBean).fetchDiskStoreObjectName(ArgumentMatchers.any(), ArgumentMatchers.any());
  ...
  public void diskStoreBeanNotFoundAndMemberDiskStoreExists() throws Exception {
    ...
    DistributedSystemMXBean distributedSystemMXBean = Mockito.mock(DistributedSystemMXBean.class);
    Mockito.doReturn(memberDiskStore).when(distributedSystemMXBean).listMemberDiskstore();
    Mockito.doThrow(new Exception("not found")).when(distributedSystemMXBean)
        .fetchDiskStoreObjectName(ArgumentMatchers.any(), ArgumentMatchers.any());
  ...
  public void diskStoreBeanExistsMemberDiskStoreIsNull() throws Exception {
    ...
    DistributedSystemMXBean distributedSystemMXBean = Mockito.mock(DistributedSystemMXBean.class);
    Mockito.doReturn(null).when(distributedSystemMXBean).listMemberDiskstore();
    Mockito.doReturn(objectName).when(distributedSystemMXBean).fetchDiskStoreObjectName(ArgumentMatchers.any(), ArgumentMatchers.any());

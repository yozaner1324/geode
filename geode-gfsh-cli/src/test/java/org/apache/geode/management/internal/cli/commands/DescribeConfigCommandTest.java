...
public class DescribeConfigCommandTest {
  ...
  public void setUp() throws Exception {
    command = Mockito.spy(DescribeConfigCommand.class);
  }
  ...
  public void passwordShouldBeRedacted() {
    ...
    doReturn(functionResult).when(command).executeFunctionAndGetFunctionResult(ArgumentMatchers.any(), ArgumentMatchers.any(), ArgumentMatchers.any());

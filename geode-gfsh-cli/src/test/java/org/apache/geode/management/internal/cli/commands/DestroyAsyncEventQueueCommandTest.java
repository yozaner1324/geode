...
public class DestroyAsyncEventQueueCommandTest {
  ...
  public void setUp() throws Exception {
    command = Mockito.spy(DestroyAsyncEventQueueCommand.class);
    ...
    Mockito.doReturn(functionResults).when(command).executeAndGetFunctionResult(
        ArgumentMatchers.any(DestroyAsyncEventQueueFunction.class), ArgumentMatchers.any(DestroyAsyncEventQueueFunctionArgs.class),

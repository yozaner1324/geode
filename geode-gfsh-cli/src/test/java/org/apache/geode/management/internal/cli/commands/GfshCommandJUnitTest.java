...
public class GfshCommandJUnitTest {
  ...
  public void before() throws Exception {
    command = Mockito.spy(GfshCommand.class);
  }

  @Test
  public void getMember() throws Exception {
    Mockito.doReturn(null).when(command).findMember("test");
    Assertions.assertThatThrownBy(() -> command.getMember("test")).isInstanceOf(EntityNotFoundException.class);
  }
  ...
  public void getMembers() throws Exception {
    ...
    Assertions.assertThatThrownBy(() -> command.getMembers(members, null))
  ...
  public void getMembersIncludingLocators() throws Exception {
    ...
    Assertions.assertThatThrownBy(() -> command.getMembersIncludingLocators(members, null))
        .isInstanceOf(EntityNotFoundException.class);
  }
}

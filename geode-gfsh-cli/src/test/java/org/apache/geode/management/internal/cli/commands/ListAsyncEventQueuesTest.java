...
public class ListAsyncEventQueuesTest {
  ...
  public void before() throws Exception {
    mockedMember = Mockito.mock(DistributedMember.class);
    anotherMockedMember = Mockito.mock(DistributedMember.class);
    command = Mockito.spy(ListAsyncEventQueuesCommand.class);
  }
  ...
  public void oneServerWithOneQueue() {
    // Mock one member
    Mockito.doReturn(new HashSet<>(Collections.singletonList(mockedMember))).when(command)
        .getAllNormalMembers();
  ...
  public void twoServersWithManyQueues() {
    ...
    Mockito.doReturn(new HashSet<>(Arrays.asList(mockedMember, anotherMockedMember))).when(command)
        .getAllNormalMembers();

...
public class QueryResultFormatterTest {
  ...
  private void checkResult(final QueryResultFormatter queryResultFormatter,
    ...
    Assertions.assertThat(jsonObject.get(RESULT)).isNotNull();
  }

  @Test
  public void canBeMocked() {
    QueryResultFormatter mockQueryResultFormatter = Mockito.mock(QueryResultFormatter.class);
    Object value = new Object();

    mockQueryResultFormatter.add("key", value);
    Mockito.verify(mockQueryResultFormatter, Mockito.times(1)).add("key", value);
  }

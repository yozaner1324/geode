...
public class ThreePhraseGeneratorTest {
  ...
  public void testGenerate() {
    ...
    Assert.assertNotNull("Generated string is null", phrase);
    Assert.assertNotEquals("Generated string is empty", "", phrase);
  }
  ...
  public void testGeneratesOnlyLetters() {
    ...
    for (int attempt = 1; attempt < 50000; ++attempt) {
      ...
      Assert.assertTrue("Generated string does not have at least five characters", 5 <= phrase.length());

...
public class CreateDefinedIndexesFunctionTest {
  ...
  public void setUp() throws Exception {
    ...
    queryService = Mockito.spy(InternalQueryService.class);
    region1 = Fakes.region("Region1", cache);
    region2 = Fakes.region("Region2", cache);
    function = Mockito.spy(CreateDefinedIndexesFunction.class);
    Mockito.doReturn(queryService).when(cache).getQueryService();
  ...
  public void noIndexDefinitionsAsFunctionArgument() throws Exception {
    ...
    Assertions.assertThat(firstResult).isInstanceOf(CliFunctionResult.class);
  ...
  public void multiIndexCreationExceptionThrowByQueryService() throws Exception {
    ...
    Mockito.when(queryService.createDefinedIndexes())
  ...
  public void creationSuccess() throws Exception {
    ...
    Assertions.assertThat(firstIndex).isNotNull();
    Assertions.assertThat(firstIndex).isInstanceOf(CliFunctionResult.class);

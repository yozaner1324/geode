...
public class CliStrings {
  ...
  public static final String ALTER_RUNTIME_CONFIG__LOG__LEVEL__HELP =
      "Log level. " + ManagementStrings.LOG_LEVEL_VALUES;
  ...
  public static final String CREATE_REGION__MSG__SPECIFY_VALID_CLASSNAME_FOR_KEYCONSTRAINT_0_IS_INVALID =
      "Specify a valid class name for " + ManagementStrings.CREATE_REGION__KEYCONSTRAINT
          + ". \"{0}\" is not valid.";
  public static final String CREATE_REGION__MSG__SPECIFY_VALID_CLASSNAME_FOR_VALUECONSTRAINT_0_IS_INVALID =
      "Specify a valid class name for " + ManagementStrings.CREATE_REGION__VALUECONSTRAINT
          + ". \"{0}\" is not valid.";
  ...
  public static final String EXPORT_LOGS__LOGLEVEL__HELP =
      "Minimum level of log entries to export.  " + ManagementStrings.LOG_LEVEL_VALUES + "  The default is ALL.";
  ...
  public static final String START_LOCATOR__LOG_LEVEL__HELP =
      "Sets the level of output logged to the Locator log file.  " + ManagementStrings.LOG_LEVEL_VALUES;

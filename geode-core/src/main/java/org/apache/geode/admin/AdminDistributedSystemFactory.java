...
public class AdminDistributedSystemFactory {
  ...
  public static AdminDistributedSystem getDistributedSystem(DistributedSystemConfig config) {
    return getDistributedSystem(config, new DefaultClassLoaderServiceImpl(LogService.getLogger()));
  }
   ...
   *
   * @param config configuration definition of the system to administer
   * @param classLoaderService the {@link ClassLoaderService} which is used to load services
   * @return administrative interface for a distributed system
   */
  public static AdminDistributedSystem getDistributedSystem(DistributedSystemConfig config,
      ClassLoaderService classLoaderService) {
    return new AdminDistributedSystemImpl((DistributedSystemConfigImpl) config, classLoaderService);
  }
